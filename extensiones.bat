...
code --install-extension rohit-chouhan.sqlite-snippet
...
code --install-extension stringham.cursor-move
code --install-extension TabNine.tabnine-vscode
code --install-extension thisismanta.cosmic-cursor
...
code --install-extension WilsonGramer.wipple
code --install-extension yo1dog.cursor-align
code --install-extension yo1dog.cursor-trim
code --install-extension yzhang.find-word-at-cursor
